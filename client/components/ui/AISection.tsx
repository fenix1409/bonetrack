  ...
  if (!aiInput) return (
    <View style={s.section}>
      <View style={s.header}>
        ...
        <Text style={[s.title, { color: c.text }]}>AI маслахатлар</Text>
      </View>
      <Card style={[s.card, { borderColor: c.border }]}>
        <Text style={[s.summary, { color: c.text }]}>AI таҳлил учун бугунги қадамлар, озик балли, БМИ ва СТЗИ керак.</Text>
        <Text style={[s.muted, { color: c.textMuted }]}>Аввал профил ва кундалик маълумотларни киритинг.</Text>
      </Card>
    </View>
  );
  ...
  return (
    <View style={s.section}>
      <View style={s.header}>
        ...
        <View style={{ flex: 1 }}>
          <Text style={[s.title, { color: c.text }]}>AI маслахатлар</Text>
          <Text style={[s.caption, { color: c.textMuted }]}>Қадамлар, озик балли, БМИ ва СТЗИ асосида</Text>
        </View>
      </View>
